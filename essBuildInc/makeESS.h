...
class makeESS
{
 private:
  ...
  boost::shared_ptr<SupplyPipe> LowReturnPipe;  ///< Lower return 
  boost::shared_ptr<SupplyPipe> TopSupplyPipe;  ///< Top supply 
  boost::shared_ptr<SupplyPipe> TopReturnPipe;  ///< Top return 
